...
const env = {
  ...
  VITE_FEATURE_REAL_TIME_UPDATES: envBool(import.meta.env.VITE_FEATURE_REAL_TIME_UPDATES, true),
  ...
  // App
  VITE_APP_NAME: envString(import.meta.env.VITE_APP_NAME, 'Travio Ghana Supplier Dashboard'),
